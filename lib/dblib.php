...
class setup_DB {
    ...
    public function select() {
        $this->sql = "SELECT * FROM ".$this->table." WHERE ".$this->table.".deleted_at IS NULL";
    ...
    public function where($option) {
        $sql = "SELECT * FROM ".$this->table." WHERE ".$this->table.".deleted_at IS NULL ";
        foreach ($option as $key => $value) {
            $sql .= "AND ".$key."=".$value ." ";
        }
        $sql .= " ORDER BY ".$this->table.".id DESC ";
    ...
    public function page($page, $index){
        $this->sql .= " LIMIT ".($page*$index)." , ".($page*$index+$index)." ";
        return $this;
    }
